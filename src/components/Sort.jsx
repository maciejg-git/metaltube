...
const SortButton = ({ label, active, direction, sort, onClick }) => {
  return (
    <button
      className={clsx(
        "flex items-center gap-x-2 rounded-full bg-gray-100 px-3 py-2 text-sm whitespace-nowrap transition-colors transition-shadow hover:bg-gray-50 dark:bg-neutral-800 hover:dark:bg-neutral-700",
